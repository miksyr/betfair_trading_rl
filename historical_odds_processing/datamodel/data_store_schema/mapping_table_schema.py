...
class CountryCodes(Table):
    def __init__(self):
        ...
        self.columns = [Column(name="id", dataType="SERIAL", primaryKey=True), Column(name="country_code", dataType="TEXT")]
...
class MarketTypes(Table):
    def __init__(self):
        ...
        self.columns = [Column(name="id", dataType="SERIAL", primaryKey=True), Column(name="market_type", dataType="TEXT")]
...
class Timezones(Table):
    def __init__(self):
        ...
        self.columns = [Column(name="id", dataType="SERIAL", primaryKey=True), Column(name="timezone", dataType="TEXT")]
...
ALL_MAPPING_SCHEMAS = [BettingTypes(), CountryCodes(), MarketStatus(), MarketTypes(), Runners(), RunnerStatus(), Timezones()]
