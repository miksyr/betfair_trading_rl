...
class TestCSVOutputHandler(TestCase):
    ...
    def setUp(self):
        super().setUp()
        self.csvOutputHandler = CSVOutputHandler(fileName=self.testFilename, tableFields=(self.firstVariableName, self.secondVariableName))
    ...
    def test_csv_output_handler_valid(self):
        ...
        expectedFirstVarData = [self.validTest1[self.firstVariableName], self.validTest2[self.firstVariableName], self.validTest3[self.firstVariableName]]
